...
This repository contains supplemental information for the article "Propensity score matching with clustered data" \url{https://onlinelibrary.wiley.com/doi/abs/10.1002/sim.6880}.
...
All algorithms can be implemented in the r environment using package [CMatching]([https://cran.r-project.org/web/packages/Matching/index.html](https://cran.r-project.org/web/packages/CMatching/index.html)).
